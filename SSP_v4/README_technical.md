...
The platform requires .NET and Python 3. Verify them in PowerShell:
...
In the **Edge address bar**, enter the following URL (do not type it into the browser console):

```text
http://127.0.0.1:5057/?v=latest
```

If port `5057` is occupied, change the command to:
